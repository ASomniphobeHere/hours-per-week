...
const MINIMAL: ContentPack = {
  ...
  copy: {
    ...
    's5.lines.2': 'Seven',
    's5.lines.3': 'Eight',
    's6.reveal.title': 'One more commitment',
    's6.reveal.body': 'Fit it into your week.',
    's6.pace.title': 'How much of your week',
    's6.pace.perDay': '{hours} h on each workday',
    's6.pace.continue': 'Continue',
    's6.confirm': 'Confirm',
